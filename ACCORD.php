...
YUI({gallery : 'gallery-2011.03.23-22-20'}).use( 'gallery-accordion', function(Y) {
...
<script>
YUI().use( 'node', 'dom-style', 'selector-css3', 'button', function(Y) {
	var oaddscrewclicked = 0;
	var oaddnewscrewclicked = 0;
	var addScrewButton = new Y.button({
		srcNode: '#addScrew'
	});
	var addNewScrewButton = new Y.button({
			srcNode: '#addNewScrew'
	});
	//Find and Create variables for button, row, and container
	addScrewButton.on('click', function(){
		oaddscrewclicked++;
		
		if(oaddscrewclicked>0){	Y.one("#screw1").setStyle('display', 'table-row'); }
		if(oaddscrewclicked>1){	Y.one("#screw2").setStyle('display', 'table-row');	}
		if(oaddscrewclicked>2){	Y.one("#screw3").setStyle('display', 'table-row');	}
		if(oaddscrewclicked>3){	Y.one("#screw4").setStyle('display', 'table-row');	}
		if(oaddscrewclicked>4){	Y.one("#screw5").setStyle('display', 'table-row');	}
		if(oaddscrewclicked>5){	Y.one("#screw6").setStyle('display', 'table-row');	}
		if(oaddscrewclicked>6){	Y.one("#screw7").setStyle('display', 'table-row');	}
		if(oaddscrewclicked>7){	Y.one("#screw8").setStyle('display', 'table-row');	}
		if(oaddscrewclicked>8){	Y.one("#screw9").setStyle('display', 'table-row');	}
	});
	addNewScrewButton.on('click', function(){
		oaddnewscrewclicked++;
		if(oaddnewscrewclicked>0){ Y.one("#newscrew1").setStyle('display', 'table-row'); }
		if(oaddnewscrewclicked>1){ Y.one("#newscrew2").setStyle('display', 'table-row'); }
		if(oaddnewscrewclicked>2){ Y.one("#newscrew3").setStyle('display', 'table-row'); }
		if(oaddnewscrewclicked>3){ Y.one("#newscrew4").setStyle('display', 'table-row'); }
		if(oaddnewscrewclicked>4){ Y.one("#newscrew5").setStyle('display', 'table-row'); }
		if(oaddnewscrewclicked>5){ Y.one("#newscrew6").setStyle('display', 'table-row'); }
		if(oaddnewscrewclicked>6){ Y.one("#newscrew7").setStyle('display', 'table-row'); }
		if(oaddnewscrewclicked>7){ Y.one("#newscrew8").setStyle('display', 'table-row'); }
		if(oaddnewscrewclicked>8){ Y.one("#newscrew9").setStyle('display', 'table-row'); }
	});
});
</script>
...
<form action="commit.php?action=add&type=tool" method="post">
    ...
    <div align="center">
        <div id="acc1" class="yui3-accordion"> <!-- If you are running in quirks mode, you may have to set the following styles for IE - style="position: relative; height: 420px; overflow: hidden;" -->
            ...
            <div id="item2" class="yui3-accordion-item" yuiConfig='{"contentHeight": {"method": "auto"}, "expanded":false}' >
                <div class="yui3-widget-hd">
                    <a class="yui3-accordion-item-icon"></a>
                    <a class="yui3-accordion-item-label"><b>Screws</b></a>
                    <div class="yui3-accordion-item-icons">
                        <a class="yui3-accordion-item-iconalwaysvisible"></a>
                        <a class="yui3-accordion-item-iconexpanded"></a>
                        <a class="yui3-accordion-item-iconclose yui3-accordion-item-iconclose-hidden"></a>
            ...
            <div id="item3" class="yui3-accordion-item" yuiConfig='{"contentHeight": {"method": "auto"}, "expanded":false}'>
                <div class="yui3-widget-hd">
                    <a class="yui3-accordion-item-icon"></a>
                    <a class="yui3-accordion-item-label"><b>O-Rings</b></a>
                    <div class="yui3-accordion-item-icons">
                        <a class="yui3-accordion-item-iconalwaysvisible"></a>
                        <a class="yui3-accordion-item-iconexpanded"></a>
                        <a class="yui3-accordion-item-iconclose yui3-accordion-item-iconclose-hidden"></a>
            ...
            <div id="item4" class="yui3-accordion-item" yuiConfig='{"contentHeight": {"method": "auto"}, "expanded":true}'>
                <div class="yui3-widget-hd">
                    <a class="yui3-accordion-item-icon"></a>
                    <a class="yui3-accordion-item-label"><b>Submit</b></a>
                    <div class="yui3-accordion-item-icons">
                        <a class="yui3-accordion-item-iconalwaysvisible"></a>
                        <a class="yui3-accordion-item-iconexpanded"></a>
                        <a class="yui3-accordion-item-iconclose yui3-accordion-item-iconclose-hidden"></a>
